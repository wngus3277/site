		...
		<div id="content">
			...
			<div class="ibtnArea">
				<span class="x_pull-right">
					<a href="<?php echo getUrl('', 'act', 'dispInstallLicenseAgreement') ?>" class="x_btn x_btn-small x_btn-inverse" id="task-choose-language"><?php echo $__Context->lang->cmd_next ?> <i class="x_icon-chevron-right x_icon-white"></i></a>
				</span>
			</div>
		</div>
	</div>
