<?php
	...
	//비밀번호 검증
	if($_POST['userPW'] == '' || $userId = $_POST['userPW'] == null){
		echo "해당 값을 사용할 수 없습니다. 3pw";
		exit;
	}
	$userPW = sha1("kim".$userPW = $_POST['userPW']);
