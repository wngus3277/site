...
echo htmlspecialchars($__Context->module_info->footer_text);
	...
	<section class="section">
		...
		<div class="x_control-group">
			...
			<div class="x_controls">
				<input type="text" name="mobile_list_count" id="mobile_list_count" value="<?php echo $__Context->module_info->mobile_list_count?$__Context->module_info->mobile_list_count:20 ?>" style="width:30px" />
				<p class="x_help-inline"><?php echo $__Context->lang->about_list_count ?></p>
			</div>
		</div>
		<div class="x_control-group">
			...
			<div class="x_controls">
				<input type="text" name="mobile_search_list_count" id="mobile_search_list_count" value="<?php echo $__Context->module_info->mobile_search_list_count?$__Context->module_info->mobile_search_list_count:20 ?>" style="width:30px" />
				<p class="x_help-inline"><?php echo $__Context->lang->about_search_list_count ?></p>
			</div>
		</div>
		<div class="x_control-group">
			...
			<div class="x_controls">
				<input type="text" name="mobile_page_count" id="mobile_page_count" value="<?php echo $__Context->module_info->mobile_page_count?$__Context->module_info->mobile_page_count:5 ?>" style="width:30px" />
